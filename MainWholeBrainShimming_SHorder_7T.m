% MainWholeBrainShimming_SHorder_7T.m 
% Shimming the brain in the world coordinate and output the shimming results
% Use SH_order to generate the shimming field

% Created. 26/05/2021 Mona
...
% only for 7T brain, the original brainmaps' size differ.
for i = 1:subjectnum
