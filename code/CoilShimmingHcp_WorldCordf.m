function [improve_STD,improve_mean,DC,B0shim_STD,B0shim_mean,B0_STD,B0_mean] = CoilShimmingHcp_WorldCordf(B0,Bzf_temp,DC_limit,resultprefix,subjectid,downpad)
% CoilShimmingHcp_WorldCordf.m
% calculate the shimming result for each subject and plot the shimming
% results
% Created. 20/10/2019 Mona
% 
% use function: PlotShimmingResult.m/PlotShimmingResult_7T.m
% Params: 
...
%     PlotShimmingResult(B0,B0shim_temp,mask,resultprefix,subjectid,downpad);
    PlotShimmingResult_7T(B0,B0shim_temp,mask,resultprefix,subjectid,downpad);
    close all
end
