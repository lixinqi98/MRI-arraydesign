% Calculated the whole brain shimming results on 7T field maps
% Brief conclusion:
...
for i = 1:subjectnum
    subplot(2,4,i)
    subjectname = filelist_ph(i+22).name;
...
savefig(f4,fullfile(resultprefix,[label,'checkBzandB0.fig']));
...
% 
% PlotReservedReducedCoil(resultprefix,label,mapped_coilcordf,x11f,y11f,z11f,helmetx,helmety,helmetz)